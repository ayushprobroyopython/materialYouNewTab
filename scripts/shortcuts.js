...
    const SHORTCUT_PRESET_NAMES = ["Youtube", "Gmail", "Telegram", "WhatsApp", "Twitter", "Discord", "Open WebUI (Local)"]; // Added "Open WebUI (Local)"
...
                </g>
            </svg>
            `], ["localhost:8080", `<img src="https://docs.openwebui.com/images/logo.png" style="height: 24px; width: 24px;"/>`]]); // Added localhost:8080
